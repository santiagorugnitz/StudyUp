namespace Exceptions
{
    ...
    public static class ExamMessage
    {
        ...
        public const string ALREADY_COMPLETED = "This exam has been already compleated";
    ...
    public static class FlashcardMessage
    {
        ...
        public const string FLASHCARDS_AUTHOR_CANNOT_COMMENT_THEIR_FLASHCARD = "Flashcards authors cannot " +
            "comment their own flashcards.";
        ...
        public const string NOT_AUTHORIZED_TO_EDIT = "Only this flashcards author can edit it.";
        public const string NOT_AUTHORIZED_TO_DELETE = "Only this flashcards author can delete it.";
        public const string LARGE_COMMENT = "The comment is longer than 180 characters.";
    }
